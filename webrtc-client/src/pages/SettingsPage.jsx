...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 dark:bg-gray-950 dark:text-secondary-100 py-10 px-2 md:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row gap-8">
          {/* Sidebar Navigation */}
          <aside className="md:w-64 w-full flex-shrink-0">
            <div className="sticky top-10">
              <nav className="space-y-2 bg-secondary-900 dark:bg-secondary-900 rounded-2xl shadow-lg p-4 border border-secondary-800 dark:border-secondary-800">
          ...
          <main className="flex-1">
            <motion.div
              ...
              className="bg-secondary-900 dark:bg-secondary-900 rounded-2xl shadow-2xl border border-secondary-800 dark:border-secondary-800 p-8 mb-8 text-secondary-100"
            >
