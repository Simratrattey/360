  ...
  return (
    <div
      className={`group relative mx-3 mb-2 p-4 rounded-xl cursor-pointer transition-all duration-300 ${
        isActive 
          ? `bg-secondary-800 border-2 border-secondary-700 shadow-lg transform scale-[1.02] text-secondary-100` 
          : 'hover:bg-secondary-800 border-2 border-transparent hover:border-secondary-700 hover:shadow-md text-secondary-100'
      }`}
      onClick={onSelect}
    >
